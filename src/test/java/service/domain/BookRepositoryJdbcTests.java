...
import service.config.DataConfig;
...
public class BookRepositoryJdbcTests {
    ...
    @Test
    void findAllBooks() {
        var book1 = Book.of("1234561235", "Title", "Author", 12.90, "Monster");
        var book2 = Book.of("1234561236", "Another Title", "Author", 12.90, "Monster");
    ...
    void findBookByIsbnWhenExisting() {
        ...
        var book = Book.of(bookIsbn, "Title", "Author", 12.90, "Eminiem");
    ...
    void deleteByIsbn() {
        ...
        var bookToCreate = Book.of(bookIsbn, "Title", "Author", 12.90, "Ciao");
